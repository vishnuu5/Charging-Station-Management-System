<template>
  <div class="space-y-6">
    <div class="flex items-center space-x-4">
      <router-link to="/stations" class="text-blue-600 hover:text-blue-500">
        ← Back to Stations
      </router-link>
  ...
  setup() {
    ...
    const form = ref({
      ...
      location: {
        ...
        longitude: "78.4867", // Default to Hyderabad coordinates
        address: "",
      },
      status: "Active",
      powerOutput: "",
    ...
    const handleSubmit = async () => {
      ...
      const result = await stationsStore.createStation(stationData);

      if (result.success) {
        success("Charging station created successfully!");
